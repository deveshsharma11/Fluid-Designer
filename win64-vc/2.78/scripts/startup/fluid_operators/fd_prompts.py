...
class OPS_update_all_prompts_in_scene(Operator):
    bl_idname = "fd_prompts.update_all_prompts_in_scene"
    ...
    prompt_name = StringProperty(name="Prompt Name")
    prompt_type = StringProperty(name="Prompt Type") # NUMBER, QUANTITY, COMBOBOX, CHECKBOX, TEXT, DISTACNE, PERCENTAGE, ANGLE, PRICE
    ...
    def execute(self, context):
        for obj in context.scene.objects:
            for prompt in obj.mv.PromptPage.COL_Prompt:
                if prompt.name == self.prompt_name:
...
classes = [
           ...
           OPS_update_all_prompts_in_scene
           ]
