...
BACKSPLASH_PART = path.join(ROOT_DIR,"Part with Edgebanding.blend")
CTOP = path.join(ROOT_DIR,"Part with Edgebanding.blend")
NOTCHED_CTOP = path.join(ROOT_DIR,"Corner Notch Part.blend")
DIAGONAL_CTOP = path.join(ROOT_DIR,"Chamfered Part.blend")
...
class PRODUCT_Straight_Countertop(fd_types.Assembly):
    ...
    def draw(self):
        ...
        deck.set_material_pointers("Countertop_Surface")
        ...
        splash.set_material_pointers("Countertop_Surface")
        ...
        left_splash.set_material_pointers("Countertop_Surface")
        ...
        right_splash.set_material_pointers("Countertop_Surface")
...
class Corner_Countertop(fd_types.Assembly):
    ...
    def draw(self):
        ...
        rear_left_splash.set_material_pointers("Countertop_Surface")
        ...
        rear_rear_splash.set_material_pointers("Countertop_Surface")
